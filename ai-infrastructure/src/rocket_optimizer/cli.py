...
from rocket_optimizer.DynamicDatabase import AstosOutput  # TODO
...
AstosOutput.stage1_tank_pressure = 5  # TODO
AstosOutput.stage2_tank_pressure = 5  # TODO
...
# material selection just updates price, not Odin model
...
# TODO: add update of safety margin calculation based on material
...
# TODO: bring code below in any other file (line 41 - 54)
input_directory = os.path.join(".input")  # Moves up one level to the parent directory
AstosOutput.odin_input_path = (
    f"config_S1{material_codes[material_stage1]}_S2{material_codes[material_stage2]}_S3{material_codes[material_stage3]}"
...
os.rename(f".input/{files[0]}", ".input/" + AstosOutput.odin_input_path + ".txt")
...
def main(
    ...
    input_path: Annotated[
        ...
        typer.Option(
            ...
            readable=True,
            resolve_path=True,
            help="Path to ASTOS input homotopy folder"
        ),
    ] = Path("./.astos-batch-script/V20_NOM_long_lat_inc_iter/batchmaster/inFiles/"),
    output_path: Annotated[
        ...
        typer.Option(
            ...
            readable=True,
            resolve_path=True,
            help="Path to ASTOS outputs folder"
        )
    ] = Path("./.astos-batch-script/V20_NOM_long_lat_inc_iter/batchmaster/outFiles/"),
    fast_mode: Annotated[
        Optional[bool],
        typer.Option(
            "--fast-mode",
